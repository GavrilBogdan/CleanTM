...
function Preloader() {
    ...
    if ($[6] === Symbol.for("react.memo_cache_sentinel")) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("filter", {
            id: "neonGlow",
            children: [
...
const UserProvider = (t0)=>{
    ...
    if ($[0] !== "f61f21bf1312d5ac42fbff9242976171c5a375e8fa009a63c647a022f86dd063") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "f61f21bf1312d5ac42fbff9242976171c5a375e8fa009a63c647a022f86dd063";
    }
    const { children } = t0;
    ...
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ()=>{
            fetch("/api/auth/me").then(_temp).then((data)=>setUser(data.user)).catch(()=>setUser(null));
        };
        t2 = [];
        $[1] = t1;
        $[2] = t2;
    ...
    let t4;
    if ($[5] !== children || $[6] !== t3) {
        t4 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(UserContext.Provider, {
            value: t3,
            children: children
        }, void 0, false, {
...
//# sourceMappingURL=_e3d5f14e._.js.map