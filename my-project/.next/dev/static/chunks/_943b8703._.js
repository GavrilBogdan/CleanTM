...
const ShopItemCard = (t0)=>{
    ...
    if ($[0] !== "39f699d627cd18a1542832f48344724dba8e9f419816ec82031f45e4f63a4abc") {
        for(let $i = 0; $i < 24; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "39f699d627cd18a1542832f48344724dba8e9f419816ec82031f45e4f63a4abc";
    }
    ...
    let t5;
    if ($[10] !== canBuy || $[11] !== item.id || $[12] !== onBuy) {
        t5 = ()=>canBuy && onBuy(item.id);
        $[10] = canBuy;
        $[11] = item.id;
        $[12] = onBuy;
        $[13] = t5;
    ...
    const t6 = `w-full py-2 rounded-full font-bold text-white shadow-md transition-all duration-300
          ${canBuy ? "bg-green-600 hover:bg-green-700 cursor-pointer" : "bg-gray-400 cursor-not-allowed"}`;
    const t7 = canBuy ? "Buy" : "Not enough points";
    let t8;
    ...
    let t9;
    if ($[18] !== t1 || $[19] !== t2 || $[20] !== t3 || $[21] !== t4 || $[22] !== t8) {
...
function ShopPage() {
    ...
    if ($[0] !== "b4cdcc931664a5f851bc53ded3ddbfd34fe531ab1d2bc378e961f519e8a2131e") {
        for(let $i = 0; $i < 22; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "b4cdcc931664a5f851bc53ded3ddbfd34fe531ab1d2bc378e961f519e8a2131e";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [];
