...
function InventoryPage() {
    ...
    if ($[0] !== "3c01f2c7728d3a63aa30c58d1b6e5061ab27537e064f52234a90a652509bee6c") {
        for(let $i = 0; $i < 16; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "3c01f2c7728d3a63aa30c58d1b6e5061ab27537e064f52234a90a652509bee6c";
    }
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t0 = [];
    ...
    const [purchases, setPurchases] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(t0);
    let t1;
    let t2;
    if ($[2] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = ({
            "InventoryPage[useEffect()]": ()=>{
                fetch("/api/shop/getPurchases?userId=1").then(_InventoryPageUseEffectAnonymous).then({
                    "InventoryPage[useEffect() > (anonymous)()]": (data)=>setPurchases(data.purchases)
                }["InventoryPage[useEffect() > (anonymous)()]"]);
            }
        })["InventoryPage[useEffect()]"];
        t2 = [];
        $[2] = t1;
    ...
    let t5;
    if ($[6] !== purchases.length) {
        t5 = purchases.length === 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
            className: "text-green-700",
            children: "You haven't bought anything yet!"
        }, void 0, false, {
            fileName: "[project]/app/shop/inventory/page.tsx",
            lineNumber: 57,
            columnNumber: 36
    ...
    let t6;
    if ($[8] !== purchases) {
        t6 = purchases.map(_InventoryPagePurchasesMap);
        $[8] = purchases;
        $[9] = t6;
    } else {
        t6 = $[9];
    ...
    if ($[10] !== t5 || $[11] !== t6) {
        t7 = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: "min-h-screen px-12 py-10 flex flex-col items-center bg-gradient-to-b from-green-50 to-purple-50",
            children: [
                t4,
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
_s(InventoryPage, "8UKF92KgDpMV6egOhHrgQDQfKzQ=");
_c = InventoryPage;
function _InventoryPagePurchasesMap(p) {
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
function _InventoryPageUseEffectAnonymous(res) {
    return res.json();
}
var _c;
