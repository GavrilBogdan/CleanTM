...
async function POST(req) {
    try {
        ...
        if (existingUser) return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        res.headers.set("Set-Cookie", `token=${token}; HttpOnly; Path=/; Max-Age=${7 * 24 * 60 * 60}; SameSite=Strict; Secure=${("TURBOPACK compile-time value", "development") === "production"}`);
        return res;
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__632824f1._.js.map